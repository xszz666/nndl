...
def run_training():
    # 处理数据集
    poems_vector, word_to_int, vocabularies = process_poems2('C:/Users/lenovo/Desktop/nndl/nndl/chap6_RNN/tangshi_for_pytorch/tangshi.txt')
...
def gen_poem(begin_word):
    poems_vector, word_int_map, vocabularies = process_poems2('C:/Users/lenovo/Desktop/nndl/nndl/chap6_RNN/tangshi_for_pytorch/tangshi.txt')  #  use the other dataset to train the network
...
pretty_print_poem(gen_poem("小"))
pretty_print_poem(gen_poem("顺"))
pretty_print_poem(gen_poem("至"))
pretty_print_poem(gen_poem("尊"))
